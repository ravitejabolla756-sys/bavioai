    ...
    <PageTransition>
      <section className="min-h-screen bg-[var(--bg-base)] pt-24">
        <div className="grid min-h-[calc(100vh-96px)] lg:grid-cols-[0.84fr_1.16fr]">
          <div className="relative flex items-center overflow-hidden border-r border-[var(--border-base)] bg-[radial-gradient(circle_at_top,rgba(123,47,190,0.2),transparent_38%),linear-gradient(180deg,#120a03,#080600)] px-6 py-12 lg:px-12">
            ...
            <div className="relative z-[1] mx-auto w-full max-w-[420px]">
              ...
              <div className="mt-10 rounded-[20px] border border-[var(--border-base)] bg-[rgba(123,47,190,0.06)] p-6">
                  ...
                  {features.map((feature) => {
                    ...
                    return (
                      <div key={feature.title} className="rounded-[18px] border border-[var(--border-base)] bg-[var(--bg-raised)] p-6">
                        <div className="flex h-12 w-12 items-center justify-center rounded-[12px] bg-[var(--brand-subtle)] text-[var(--brand)]">
